...
<div class="p-6">
    ...
    <div class="bg-white shadow-md rounded p-5">
        ...
        <div class="bg-green-600 rounded py-2 px-3 w-full block text-white mb-2.5 float-start">
            {{ session('success') }}
        </div>
    @elseif (session()->has('errors'))
        @foreach ($errors->all() as $error)
            <div class="bg-red-500 rounded py-2 px-3 w-full block text-white mb-2.5 float-start">
                {{ $error }}
            </div>
        @endforeach
    @endif
